        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50/50">
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Code</TableHead>
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Description</TableHead>
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Discount</TableHead>
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Min Purchase</TableHead>
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Usage</TableHead>
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Status</TableHead>
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Valid Period</TableHead>
            ...
            {filteredPromoCodes.length === 0 ? (
              ...
              filteredPromoCodes.map((promoCode) => (
                <TableRow key={promoCode.id} className="hover:bg-gray-50/50 transition-colors">
                  <TableCell className="px-8 py-5 font-semibold text-gray-900">{promoCode.code}</TableCell>
                  <TableCell className="px-8 py-5 text-gray-600">{promoCode.description || '-'}</TableCell>
                  ...
                  <TableCell className="px-8 py-5 text-gray-600">
                  ...
                  <TableCell className="px-8 py-5">
                    <Badge className={promoCode.isActive ? 'bg-green-500' : 'bg-gray-400'}>
