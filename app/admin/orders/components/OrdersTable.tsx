        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50/50">
              ...
              <TableHead className="px-8 py-5 font-semibold text-gray-900">Total</TableHead>
          ...
          <TableBody>
            {filteredOrders.length === 0 ? (
              <TableRow>
                <TableCell colSpan={7} className="text-center text-gray-500 py-16 px-6">
              ...
              filteredOrders.map((order) => (
                <TableRow key={order.id} className="hover:bg-gray-50/50 transition-colors">
                  <TableCell className="px-8 py-5 font-mono text-sm text-gray-900">{order.bookingCode}</TableCell>
                  ...
                  <TableCell className="px-8 py-5 text-gray-600">{order.plan.name}</TableCell>
                  <TableCell className="px-8 py-5 text-gray-600">{formatPrice(order.totalCents, order.currency || 'IDR')}</TableCell>
                  <TableCell className="px-8 py-5">
                    <Badge className={getStatusColor(order.status)}>{order.status}</Badge>
                  </TableCell>
                  <TableCell className="px-8 py-5 text-gray-600">{new Date(order.createdAt).toLocaleDateString()}</TableCell>
